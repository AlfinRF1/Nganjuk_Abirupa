...
public class DetailRoro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        call.enqueue(new Callback<WisataModel>() {
            ...
            public void onFailure(Call<WisataModel> call, Throwable t) {
                Toast.makeText(DetailRoro.this, "Error: " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btnPesan.setOnClickListener(v -> {
            ...
            intent.putExtra("id_wisata", "roro");

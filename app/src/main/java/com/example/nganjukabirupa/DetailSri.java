...
public class DetailSri extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tirta); // layout khusus Sri Tanjung
        ...
        Call<WisataModel> call = apiService.getDetailWisata(4);
        ...
        call.enqueue(new Callback<WisataModel>() {
            ...
            public void onResponse(Call<WisataModel> call, Response<WisataModel> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    Glide.with(DetailSri.this)
                            .load(R.drawable.wisata_sritanjung)
                            .error(R.drawable.wisata_sritanjung)
                            .into(imgHeader);
                } else {
                    Toast.makeText(DetailSri.this, "Gagal ambil data", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<WisataModel> call, Throwable t) {
                Toast.makeText(DetailSri.this, "Error: " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
